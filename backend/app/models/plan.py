...
class CleaningStep(BaseModel):
    tool_name: Literal["pandas","pyjanitor"] = Field(min_length=1,description="The name of the tool/library to use (e.g., pandas, pyjanitor).")
    action: str = Field(min_length=1,description="The specific function to call (e.g., drop_duplicates, fill_empty).")
