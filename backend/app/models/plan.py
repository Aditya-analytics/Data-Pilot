...
class CleaningStep(BaseModel):
    ...
    action: Literal[
        "standardize_nulls", "strip_whitespace", "lowercase_strings", "cast_to_float", 
        "parse_datetime", "extract_datetime_features", "nullify_outliers", "validate_emails", 
        "drop_duplicates", "dropna", "impute_mean", "impute_median", "impute_mode", 
        "clean_names", "remove_empty", "standard_scale", "minmax_scale", 
        "label_encode", "onehot_encode"
    ] = Field(description="The specific function to call.")
